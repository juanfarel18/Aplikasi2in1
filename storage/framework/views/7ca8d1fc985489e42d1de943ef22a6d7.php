    ...
    >
      ...
      >
        ...
        <p class="text-center mt-4 text-sm text-gray-600">
          Belum punya akun?
          <a href="<?php echo e(route('register')); ?>" class="text-[#F97316] hover:underline">Daftar</a>
        </p>
      </div>
    </div>
    ...
    <section class="pt-20 relative bg-white">
      <div class="relative overflow-hidden w-screen h-[70vh] slider-gradient">
        <div
          id="slider"
          class="flex"
          style="width: <?php echo e(count($sliders ?? []) * 100); ?>vw; transform: translateX(0);"
        >
          <?php $__currentLoopData = $sliders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($slider->link ?? '#'); ?>" class="flex-shrink-0 w-screen h-full block">
                <img
                    src="<?php echo e(asset('storage/' . $slider->image_path)); ?>"
                    alt="<?php echo e($slider->title ?? 'Slider Image'); ?>"
    ...
    <section id="about" class="py-12 px-4 sm:px-8 bg-black">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <a
            href="<?php echo e(url('indexlaundry')); ?>"
            class="group text-center bg-white/90 border rounded-xl p-4 transition hover:bg-[#F97316]"
          >
            <img
              src="<?php echo e(asset('assets/images/icons/ic-ldr1.png')); ?>"
         ...
         <a
    href="<?php echo e(route('carwash.page')); ?>"
    class="group text-center bg-white/90 border rounded-xl p-4 transition hover:bg-[#F97316]">
    <img
      src="<?php echo e(asset('assets/images/icons/ic-car1.png')); ?>"
      class="w-16 h-16 mx-auto mb-3"
      alt="Car Wash"
    />
...
<?php /**PATH C:\xampp\aplikasi-2in1\resources\views/promo/index.blade.php ENDPATH**/ ?>